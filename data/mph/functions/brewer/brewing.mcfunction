...
#ejecting false fuel
execute if data block ~ ~ ~ {BurnTime: 0s} unless block ~ ~ ~ minecraft:furnace{Items:[{id:"minecraft:suspicious_stew",Count:1b,tag:{mph_gas:1b}}]} unless block ~ ~ ~ minecraft:furnace{Items:[]} run function mph:brewer/dispense
...
execute if data block ~ ~ ~ {BurnTime: 999s} unless block ~ ~ ~ minecraft:furnace{Items:[{Slot:0b,id:"minecraft:rabbit",Count:1b,tag:{mph_placeholder_crafting_item:1b}}]} unless block ~ ~ ~ minecraft:furnace{Items:[{Slot:2b}]} at @s run function mph:brewer/explosion
execute if data block ~ ~ ~ {BurnTime: 999s} unless block ~ ~ ~ minecraft:furnace{Items:[{Slot:1b,id:"minecraft:suspicious_stew",Count:1b,tag:{mph_gas:1b}}]} unless block ~ ~ ~ minecraft:furnace{Items:[{Slot:2b}]} at @s run function mph:brewer/explosion
